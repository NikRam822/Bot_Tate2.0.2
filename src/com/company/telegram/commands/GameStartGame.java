...
//        setHashMap();
        ...
        switch (gameCode){
            ...
            case 2:
                if(parseInt(data)!=answer&parseInt(data)>answer ){gameCode=2; return "Больше";}
                if(parseInt(data)!=answer&parseInt(data)<answer){gameCode=2;return "Меньше";}
                if(parseInt(data)==answer){gameCode=0;return "Победа,Спасибо за игру!Возвращайтесь еще.";}
                gameCode=3;
                return "Ставки сделаны! Ну,что же ,начнем!\nПопробуй угадать число!";
        }
